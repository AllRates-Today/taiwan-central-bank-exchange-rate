// Central Bank of the Republic of China (Taiwan) exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbc';
...
/** Latest rate for one pair, e.g. getRate('USD', 'TWD', { apiKey }). */
